...
GLOBAL sph_haval160_3_context     z_haval60_3;
GLOBAL sph_haval160_4_context     z_haval60_4;
GLOBAL sph_haval160_5_context     z_haval60_5;
GLOBAL sph_haval192_3_context     z_haval92_3;
GLOBAL sph_haval192_4_context     z_haval92_4;
GLOBAL sph_haval192_5_context     z_haval92_5;
GLOBAL sph_haval224_3_context     z_hava224_3;
GLOBAL sph_haval224_4_context     z_hava224_4;
GLOBAL sph_haval224_5_context     z_hava224_5;
GLOBAL sph_haval256_3_context     z_hava256_3;
GLOBAL sph_haval256_4_context     z_hava256_4;
GLOBAL sph_haval256_5_context     z_hava256_5;
...
#define ZMD5 (memcpy(&ctx_md2, &z_md2, sizeof(z_md2)))
...

{
	...
	//sph_haval224_4_context     ctx_hava224_4;
	//sph_haval224_5_context     ctx_hava224_5;
	//sph_haval256_3_context     ctx_hava256_3;
	//sph_haval256_4_context     ctx_hava256_4;
	//sph_haval256_5_context     ctx_hava256_5;
	...
	sph_haval224_3_init(&ctx_panama); //9
	...
	sph_shabal_init(&ctx_shabal); //no 48
	sph_shabal(&ctx_shabal, static_cast<const void*>(&hash[15]), 64);
	sph_shabal_close(&ctx_shabal, static_cast<void*>(&hash[16]));
	...
	sph_shabal_init(&ctx_shabal); //no 48
	sph_shabal(&ctx_shabal, static_cast<const void*>(&hash[65]), 64);
	sph_shabal_close(&ctx_shabal, static_cast<void*>(&hash[66]));
	...
	sph_shabal_init(&ctx_shabal); //no 48
	sph_shabal(&ctx_shabal, static_cast<const void*>(&hash[115]), 64);
	sph_shabal_close(&ctx_shabal, static_cast<void*>(&hash[116]));
	...
	sph_shabal_init(&ctx_shabal); //no 48
	sph_shabal(&ctx_shabal, static_cast<const void*>(&hash[165]), 64);
	sph_shabal_close(&ctx_shabal, static_cast<void*>(&hash[166]));
	...
	sph_shabal_init(&ctx_shabal); //no 48
	sph_shabal(&ctx_shabal, static_cast<const void*>(&hash[215]), 64);
	sph_shabal_close(&ctx_shabal, static_cast<void*>(&hash[216]));
	...
	sph_shabal_init(&ctx_shabal); //no 48
	sph_shabal(&ctx_shabal, static_cast<const void*>(&hash[265]), 64);
	sph_shabal_close(&ctx_shabal, static_cast<void*>(&hash[266]));
	...
	sph_shabal_init(&ctx_shabal); //no 48
	sph_shabal(&ctx_shabal, static_cast<const void*>(&hash[315]), 64);
	sph_shabal_close(&ctx_shabal, static_cast<void*>(&hash[316]));
	...
	sph_shabal_init(&ctx_shabal); //no 48
	sph_shabal(&ctx_shabal, static_cast<const void*>(&hash[365]), 64);
	sph_shabal_close(&ctx_shabal, static_cast<void*>(&hash[366]));
	...
	sph_shabal_init(&ctx_shabal); //no 48
	sph_shabal(&ctx_shabal, static_cast<const void*>(&hash[415]), 64);
	sph_shabal_close(&ctx_shabal, static_cast<void*>(&hash[416]));
	...
	sph_shabal_init(&ctx_shabal); //no 48
	sph_shabal(&ctx_shabal, static_cast<const void*>(&hash[465]), 64);
	sph_shabal_close(&ctx_shabal, static_cast<void*>(&hash[466]));
