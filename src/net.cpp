...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "TorvaCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"torvacoin.org", "dnsseed.torvacoin.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"torvacoin.org", "testnet-seed.torvacoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TorvaCoin is probably already running."), addrBind.ToString().c_str());
        else
